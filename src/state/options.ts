 ...
 * @type {LGOptions}
 */
export const _opts: LGOptions = { ..._defaults };
 ...
 */
export function _resetOptions(options: Partial<LGOptions> = {}) {
    for (const k of Object.keys(_opts)) delete (_opts as unknown as Record<string, unknown>)[k];
